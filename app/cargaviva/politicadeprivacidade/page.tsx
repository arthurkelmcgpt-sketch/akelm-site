          ...
          <div className="overflow-hidden rounded-[2rem] border border-white/10 bg-white/90 shadow-[0_28px_80px_rgba(2,10,6,0.26)] backdrop-blur">
            <div className="border-b border-[#e7e2d7] px-5 py-8 sm:px-8 sm:py-10">
              ...
              <p className="mt-5 max-w-3xl text-base leading-8 text-[#4f5f57] sm:text-lg">
                ...
                CargaViva Fretes trata dados pessoais e informações dos
                usuários.
              </p>

              <p className="mt-4 max-w-3xl text-base leading-8 text-[#4f5f57] sm:text-lg">
                O aplicativo é desenvolvido e mantido pela Akelm Tecnologia e
                atua como plataforma de tecnologia para aproximar clientes que
                precisam contratar fretes e motoristas que oferecem serviços de
                transporte.
              </p>
